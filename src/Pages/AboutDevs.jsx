            ...
            >
              ...
              <div className="overflow-hidden mt-2 flex flex-col items-center transition-all ease-in-out duration-200" tabindex="0">
                ...
                <div class="relative inline-flex group/ig1 mb-8 mt-8">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#instagram-gradient)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <defs>
