...
export default function Footer() {
    return (
        <div
            className="mt-24 bg-transparent lg:mt-0 lg:absolute bottom-0 shadow-[0_-1px_4px_rgba(0,0,0,0.3)] py-4 container grid grid-cols-1 lg:grid-cols-2 gap-16 text-center lg:text-left">
