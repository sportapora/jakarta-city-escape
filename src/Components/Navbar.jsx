export default function Navbar() {
    return (
        <nav className="w-screen bg-transparent shadow fixed top-0 z-50 transition-all duration-500 font-worksans font-extralight">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-[6rem] py-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    {/*<img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo"/>*/}
                    <span
                        className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">JakartaTrip</span>
                </a>
